...
val cities = listOf("Барнаул", "Бийск", "Новосибирск", "Томск", "Омск", "Красноярск", "Иркутск", "Новокузнецк", "Кемерово", "Тюмень", "Оренбург", "Челябинск", "Екатеринбург", "Пермь", "Уфа")

// Переменные для хранения текущего направления, количества пассажиров и поезда
